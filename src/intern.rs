...
pub fn prewarm_interner() {
    let common_strings = [
        ...
        "LC_ALL", "EDITOR", "VISUAL", "PAGER", "HOSTNAME", "PS1", "PS2",
        "IFS", "SHLVL", "RANDOM", "SECONDS", "LINENO", "PPID", "UID", "EUID",
        "BASH_VERSION", "ZSH_VERSION", "FSH_VERSION", "JSH",
        // Common keywords/builtins
        "if", "then", "else", "elif", "fi", "case", "esac", "for", "while",
        "until", "do", "done", "in", "function", "select", "time", "coproc",
        "echo", "cd", "pwd", "export", "unset", "set", "local", "readonly",
        "source", "exit", "return", "break", "continue", "shift", "test",
        "true", "false", "alias", "unalias", "type", "which", "command",
        "builtin", "eval", "exec", "trap", "wait", "jobs", "fg", "bg",
        "read", "printf", "declare", "typeset", "let", "history",
